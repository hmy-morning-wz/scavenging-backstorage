          ...
          <div class="compoundQuery">
            ...
            <div class="optionLine2">              
              ...
              <div class="each">
                ...
                <el-select class="smallSe" v-model="compoundSearchParams.channelCode" disabled clearable placeholder="请选择">
                  <el-option
              ...
              <div class="each">
                <el-tag type="info" plain>钱包类型</el-tag>
                <el-select class="smallSe" v-model="compoundSearchParams.attach" disabled clearable placeholder="国际钱包">
                </el-select>
              </div> 
            </div>
          </div>
