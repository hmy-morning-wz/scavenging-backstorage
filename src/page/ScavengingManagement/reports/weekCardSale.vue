      ...
      <el-card shadow='never'>
        <div>
          ...
          <div style="margin-left:11rem;">
            <el-button class="chooseBtn" :class="{activeBtn : searchParams.type === 'sale'} " @click="handleClick('sale',2)" style="float: left;border-right:none">售卖</el-button>
            <el-button class="chooseBtn" :class="{activeBtn : searchParams.type === 'refund'} " @click="handleClick('refund',2)" style="float: left;border-left:none;">退卡</el-button> 
          </div>
        </div>
