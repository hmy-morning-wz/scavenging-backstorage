      ...
      <div class="queryResult">
        ...
        <div class="tableList">
            <el-table :data="tableData" size="small" border>
              <el-table-column prop="time" label="渠道抵扣" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getTableList(page){
      ...
      this.getTotalTable()
      cardServer.discountStatistics(this.searchParams).then(
        response => {
    ...
    chartsExport() {
      ...
      const url = '/export/channel/tax/statics'
    ...
    getTotalTable() {
      cardServer.discountTotalStatistics(this.searchParams).then(
        response => {
