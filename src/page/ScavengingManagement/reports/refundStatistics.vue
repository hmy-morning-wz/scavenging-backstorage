      ...
      <div class="queryResult">
        ...
        <div class="tableList">
            <el-table :data="tableData" size="small" border>
              <el-table-column prop="time" label="退卡" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getTableList(page){
      ...
      this.getTotalTable()
      cardServer.refundStatistics(this.searchParams).then(
        response => {
    ...
    getTotalTable() {
      cardServer.refundTotalStatistics(this.searchParams).then(
        response => {
