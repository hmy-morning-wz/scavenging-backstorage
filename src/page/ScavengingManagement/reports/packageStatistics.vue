      ...
      <div class="queryResult">
        ...
        <div class="tableList">
            <el-table :data="tableData" size="small" border>
              <el-table-column prop="time" label="套餐购买" align="center"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    getTableList(page){
      ...
      this.getTotalTable()
      cardServer.packageStatistics(this.searchParams).then(
        response => {
    ...
    getTotalTable() {
      cardServer.packageTotalStatistics(this.searchParams).then(
        response => {
