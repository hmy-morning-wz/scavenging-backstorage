      ...
      <el-card shadow='never'>
        <div>
          ...
          <div style="margin-left:11rem;">
            <el-button class="chooseBtn" :class="{activeBtn : searchParams.type === 'amount'} " @click="handleClick('amount',2)" style="float: left;border-right:none">结算金额</el-button>
            <el-button class="chooseBtn" :class="{activeBtn : searchParams.type === 'activate'} " @click="handleClick('activate',2)" style="float: left;border-left:none;">生效数量</el-button> 
          </div>
        </div>
      ...
      <div class="queryResult">
        ...
        <div class="tableList">
            <el-table :data="tableData" size="small" border>
              <el-table-column prop="time" label="周期卡结算" align="center"></el-table-column>
