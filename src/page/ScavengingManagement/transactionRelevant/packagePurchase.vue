            ...
            <el-tab-pane name="first">
              ...
              <div class="fastQuery">
                <el-tabs v-model="activeName2" type="card">
                  ...
                  <el-tab-pane label="渠道交易号" name="first">                
      ...
      <div class="queryResult" v-show="activeName==='first'">
        <div class="tableList">
            <el-table :data="rechargeList" size="small" border>
                ...
                <el-table-column prop="cityCode" label="CityCode" align="center"></el-table-column>
                <el-table-column prop="issuerName" label="交易商户" align="center">
                  <template slot-scope="scope" style="text-align:center">
                      <div class="nowWrap">{{scope.row.issuerName}}</div>
                  </template>
                </el-table-column>
                <el-table-column prop="orderNum" label="商户订单号" show-overflow-tooltip align="center">
                    <template slot-scope="scope" class="detail-content">
                        <div class="detail-content">{{hidden(scope.row.orderNum,'.',4,4)}}</div>
                    </template>
                </el-table-column>
                <el-table-column prop="channelName" label="渠道" show-overflow-tooltip align="center"></el-table-column>              
                <el-table-column prop="cardNo" label="卡号" show-overflow-tooltip align="center">
                    <template slot-scope="scope" class="detail-content">
                        <div class="detail-content">{{hidden(scope.row.cardNo,'.',4,4)}}</div>
                    </template>
                </el-table-column>
                <el-table-column prop="bizTime" label="交易时间" align="center" ></el-table-column>
                <el-table-column prop="amt" label="交易金额/元" align="center" >
                  <template slot-scope="scope" class="detail-content">
                      <div class="detail-content">{{scope.row.consumeAmt/100}}</div>
                  </template>
                </el-table-column>
                <el-table-column prop="statusName" label="交易状态" align="center" ></el-table-column>
      ...
      <div class="queryResult" v-show="activeName==='second'">
        <div class="tableList">
            <el-table :data="rechargeList2" size="small" border>
                ...
                <el-table-column prop="channelName" label="渠道" show-overflow-tooltip align="center"></el-table-column>              
                <el-table-column prop="channelNum" label="渠道交易号" show-overflow-tooltip align="center">
                    <template slot-scope="scope" class="detail-content">
                        <div class="detail-content">{{hidden(scope.row.channelNum,'.',4,4)}}</div>
                    </template>
                </el-table-column>
                <el-table-column prop="cardNo" label="卡号" show-overflow-tooltip align="center">
                    <template slot-scope="scope" class="detail-content">
                ...
                <el-table-column prop="bizTime" label="交易时间" align="center" ></el-table-column>
                <el-table-column prop="ticketName" label="交易套餐" show-overflow-tooltip align="center"></el-table-column>              
                <el-table-column prop="amt" label="交易金额/元" align="center" >
                  <template slot-scope="scope" class="detail-content">
                      <div class="detail-content">{{scope.row.consumeAmt/100}}</div>
                  </template>
...
export default {
  ...
  methods: {
    ...
    getTableList(data){
      ...
      tradeServer.getPackageData(data).then(
        response => {
          if(response.cardTickets instanceof Array) {
            if(this.activeName === 'first'){
              this.rechargeList = response.cardTickets
              this.totalSize = response.totalCount
            } else {
              this.rechargeList2 = response.cardTickets
